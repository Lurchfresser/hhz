...
pub const WHITE_QUEENSIDE_CASTLING_MASK: u64 = 14;

pub const WHITE_KINGSIDE_CASTLE_INDEX: usize = 2;
...
pub const BLACK_QUEENSIDE_CASTLING_MASK: u64 = 1008806316530991104;
